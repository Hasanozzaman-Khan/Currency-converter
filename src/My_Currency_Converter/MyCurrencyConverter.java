...
public class MyCurrencyConverter extends javax.swing.JFrame {
    ...
    double Australia_Dollar = 1.50;
    double Bangladeshi_Taka = 150.00;
    /**
    ...
    private void initComponents() {
        ...
        secondCountry.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Choose one . . .", "USA", "Nigeria", "Brazil", "Canada", "Kenyan", "Indonesia", "India", "Philippine", "Pakistan", "Australia", "Bangladesh" }));
        ...
        firstCountry.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Choose one . . .", "USA", "Nigeria", "Brazil", "Canada", "Kenyan", "Indonesia", "India", "Philippine", "Pakistan", "Australia", "Bangladesh" }));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(firstCountry, 0, 213, Short.MAX_VALUE)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(secondCountry, javax.swing.GroupLayout.Alignment.TRAILING, 0, 213, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(firstCountry.getSelectedIndex() == 0 || secondCountry.getSelectedIndex() == 0 || t1.getText().equals("")){
            ...
            JOptionPane.showMessageDialog(null,
                    "You must select both countries & input the amount.", "Error message.",
        ...
        switch(firstCountry.getSelectedItem().toString()){
            ...
            case "Australia" : amountInPounds = amountToChange / Australia_Dollar;break;
        ...
        switch(secondCountry.getSelectedItem().toString()){
            ...
            case "Australia" : amountChanged = amountInPounds * Australia_Dollar;break;
            case "Bangladesh" : amountChanged = amountInPounds * Bangladeshi_Taka;break;
            default : amountChanged = amountInPounds * 0.00;
        }
